  ...
  themes: [
    {
      ...
      tracks: [
        ...
        { id: 1440787711, artist: 'Rodgers & Hammerstein', title: 'Oh, What a Beautiful Mornin\'', note: 'From the musical Oklahoma!' },
    ...
    },
    {
      ...
      tracks: [
        { id: 1590368453, artist: 'Taylor Swift', title: 'Red (Taylor\'s Version)', note: 'Red' },
        { id: 1441133197, artist: 'The Beatles', title: 'Back in the U.S.S.R.', note: 'The White Album' },
        { id: 1890580960, artist: 'Weezer', title: 'Buddy Holly', note: 'The Blue Album' },
        { id: 1572046440, artist: 'Metallica', title: 'The Unforgiven', note: 'The Black Album' },
      ],
    },
    {
      theme: 'Bo Diddley Beat',
      tracks: [
